...
for checkpoint_freq in [1, 5, 10, 15, 20]:
    ...
    for model_config in models_config:
        ...
        total_time, total_checkpoint_time = benchmark_model(model_name, tokenizer_class, model_class, pretrained_model_name, iterations_per_epoch=20, checkpoint_freq=checkpoint_freq)
...
# 输出结果到 JSON 文件
with open("result3n.json", "w") as f:
    json.dump(all_results, f, indent=4)

print("Benchmark results saved to result3.json")
