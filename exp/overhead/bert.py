...
def benchmark_bert(batch_size=1, iterations_per_epoch=10):
    print("Running benchmark for BERT...")
    iteration_times = []
    ...
    print(f"Total training time for 1 epoch with BERT (excluding first iteration):", sum(iteration_times))

    return sum(iteration_times)

# 运行基准测试并保存结果
total_time = benchmark_bert()
