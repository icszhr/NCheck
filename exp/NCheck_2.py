...
def benchmark_model(model_name, tokenizer_class, model_class, pretrained_model_name, batch_size=1, iterations_per_epoch=20):
...
for model_config in models_config:
    ...
    total_time = benchmark_model(model_name, tokenizer_class, model_class, pretrained_model_name, iterations_per_epoch=20)
    results.append({
...
# 输出结果到文件
with open("result5.json", "w") as f:
    json.dump(results, f, indent=4)

print("Benchmark results saved to result5.json")
