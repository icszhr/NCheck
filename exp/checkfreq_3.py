...
def benchmark_model(model_name, tokenizer_class, model_class, pretrained_model_name, batch_size=8, iterations_per_epoch=21, checkpoint_freq=10):
...
for batch_size in [1, 2, 4, 8]:
    ...
    for model_config in models_config:
        ...
        total_time, total_checkpoint_time = benchmark_model(model_name, tokenizer_class, model_class, pretrained_model_name, batch_size=batch_size, checkpoint_freq=10)
...
# 输出结果到 JSON 文件
with open("result2_2.json", "w") as f:
    json.dump(all_results, f, indent=4)

print("Benchmark results saved to result2_2.json")
